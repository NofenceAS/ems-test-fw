...
ID_ACC_SIGMA_NOACT = (0x08, "H")
ID_ACC_SIGMA_SLEEP = (0x09, "H")
ID_OFF_ANIMAL_TIME = (0x0A, "H")
ID_FLASH_TEACH_MODE_FINISHED = (0x0B, "B")
ID_FLASH_KEEP_MODE = (0x0C, "B")
ID_FLASH_ZAP_CNT_TOT = (0x0D, "H")
ID_FLASH_ZAP_CNT_DAY = (0x0E, "H")
ID_FLASH_WARN_CNT_TOT = (0x0F, "I")
...
CMD_CLEAR_PASTURE = 0xC0
CMD_ERASE_FLASH = 0xEF
