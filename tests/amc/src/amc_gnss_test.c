...
void test_gnss_fix(void)
{
	...
	zassert_equal(gnss_init(gnss_timeout), 
		      0, 
	...
	zassert_equal(gnss_update(&gnss_data),
		      0,
		      "Failed updating GNSS fix");

	/* Verify state of fix */
	zassert_true(gnss_has_fix(),
		      "Did not have fix");
	zassert_false(gnss_has_accepted_fix(),
		      "Did have accepted fix");
	zassert_false(gnss_has_easy_fix(),
		      "Did have easy fix");
	...
	zassert_false(gnss_has_accepted_fix(),
		      "Did have accepted fix");
	zassert_true(gnss_has_easy_fix(),
		      "Did not have easy fix");
	...
	zassert_true(gnss_has_fix(),
		      "Did not have fix");
	zassert_true(gnss_has_accepted_fix(),
		      "Did not have accepted fix");
	zassert_true(gnss_has_easy_fix(),
		      "Did not have easy fix");
