...
static void test_setup(void)
{
    ...
    uint8_t cmd_cfg_setval_nav_pl[] = {0xB5, 0x62, 0x06, 0x8A, 0x09 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00, 0x16 ,0x04, 0x91 ,0x20 ,0x01, 0x68, 0xB3};
    uint8_t resp_cfg_setval_nav_pl[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
    gnss_add_expected_cmd_rsp(cmd_cfg_setval_nav_pl,
			      sizeof(cmd_cfg_setval_nav_pl),
			      resp_cfg_setval_nav_pl,
			      sizeof(resp_cfg_setval_nav_pl));

    /* Enable MGA-ACK output on UART */
	uint8_t cmd_cfg_setval_mga_ack[] = {0xB5, 0x62, 0x06, 0x8A, 0x09, 0x00, 0x00, 0x03, 0x00, 0x00, 0x25, 0x00, 0x11, 0x10, 0x01, 0xe3, 0x4e};
	uint8_t resp_cfg_setval_mga_ack[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
    gnss_add_expected_cmd_rsp(cmd_cfg_setval_mga_ack,
                              sizeof(cmd_cfg_setval_mga_ack),
                              resp_cfg_setval_mga_ack,
                              sizeof(resp_cfg_setval_mga_ack));
...
static void test_receive_gnss_solution(void)
{
	...
	uint8_t nav_dop_01[] = {0xB5, 0x62, 0x01, 0x04, 0x12, 0x00, 0x58, 0xF9, 0x28, 0x08, 0xC7, 0x00, 0xAD, 0x00, 0x62, 0x00, 0x98, 0x00, 0x54, 0x00, 0x48, 0x00, 0x2C, 0x00, 0xCE, 0x85};
        uint8_t nav_pl_01[] = {0xB5,0x62,0x01,0x62,0x34,0x00,0x01,0x05,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x58, 0xF9, 0x28, 0x08,0xA0,0x2F,0x00,0x00,0xAD,0x1E,0x00,0x00,0x30,0x57,0x00,
				0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x41,0x35};
	...
	mock_uart_send(uart_dev, nav_sat_01, sizeof(nav_sat_01));
...
static void test_ignore_nmea(void)
{
	...
	uint8_t nav_pl_03[] = {0xB5,0x62,0x01,0x62,0x34,0x00,0x01,0x05,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x28, 0x01, 0x29, 0x08, 0xE6,0x2F,0x00,0x00,0xAD,0x1E,0x00,0x00,0x30,0x57,0x00,
				0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0xEB};
	...
	mock_uart_send(uart_dev, nav_sat_03, sizeof(nav_sat_03));
	...
	uint8_t nav_pl_04[] = {0xB5,0x62,0x01,0x62,0x34,0x00,0x01,0x05,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10, 0x05, 0x29, 0x08, 0xE6,0x2F,0x00,0x00,0xAD,0x1E,0x00,0x00,0x30,0x57,0x00,
				0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x4C,0xC7};
	...
	mock_uart_send(uart_dev, nav_sat_04, sizeof(nav_sat_04));
	/* Expect data now */
	zassert_equal(k_sem_take(&gnss_data_sem, K_MSEC(100)), 0 , 
		      "No data received");
}
...
static void test_ignore_garbage(void)
{
	...
	uint8_t nav_pl_05[] = {0xB5,0x62,0x01,0x62,0x34,0x00,0x01,0x05,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF8, 0x08, 0x29, 0x08, 0xE6,0x2F,0x00,0x00,0xAD,0x1E,0x00,0x00,0x30,0x57,0x00,
				0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x37,0x7C};
	...
	mock_uart_send(uart_dev, nav_sat_05, sizeof(nav_sat_05));
...
static void test_upload_assistance_data(void)
{
	...
	uint8_t rsp_mga_ano[] = {0xb5, 0x62, 0x13, 0x60, 0x8, 0x0, 0x1, 0x0, 0x0, 0x20, 0x0, 0x1, 0x2, 0x3, 0xa2, 0x6};
 ...
 */
 ...
 static void test_set_power_mode_psm(void) {
     gnss_clear_expected();
     /* Expect valset for rate set command */
     uint8_t cmd_cfg_setval_rate[] = {0xB5, 0x62, 0x06, 0x8A, 0x0A, 0x00, 0x00, 0x03,
                                      0x00, 0x00, 0x01, 0x00, 0x21, 0x30, 0x88, 0x13, 0x8A, 0x26};
     uint8_t resp_cfg_setval_rate[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
     gnss_add_expected_cmd_rsp(cmd_cfg_setval_rate,
                               sizeof(cmd_cfg_setval_rate),
                               resp_cfg_setval_rate,
     ...
     uint8_t cmd_cfg_setval_operatemode[] = {0xB5,0x62,0x06,0x8A,0x09,0x00,0x00,0x03,0x00,0x00,0x01,0x00,0xD0,0x20,0x02,0x8F,0xF8};
     uint8_t resp_cfg_setval_operatemode[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
     gnss_add_expected_cmd_rsp(cmd_cfg_setval_operatemode,
                               sizeof(cmd_cfg_setval_operatemode),
                               resp_cfg_setval_operatemode,
                               sizeof(resp_cfg_setval_operatemode));
...
static void test_set_power_mode_max(void) {
    ...
    /* Expecy valset for UBX_CFG_PM_OPERATEMODE */
    uint8_t cmd_cfg_setval_operatemode[] = {0xB5,0x62,0x06,0x8A,0x09,0x00,0x00,0x03,
                                            0x00,0x00,0x01,0x00,0xD0,0x20,0x00,0x8D,0xF6};
    uint8_t resp_cfg_setval_operatemode[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
    gnss_add_expected_cmd_rsp(cmd_cfg_setval_operatemode,
                              sizeof(cmd_cfg_setval_operatemode),
                              resp_cfg_setval_operatemode,
    ...
    /* Expect valset for rate set command */
    uint8_t cmd_cfg_setval_rate[] = {0xB5, 0x62, 0x06, 0x8A, 0x0A, 0x00, 0x00, 0x03,
                                     0x00, 0x00, 0x01, 0x00, 0x21, 0x30, 0xFA, 0x00, 0xE9, 0xF7};
    uint8_t resp_cfg_setval_rate[] = {0xB5, 0x62, 0x05, 0x01, 0x02, 0x00, 0x06, 0x8A, 0x98, 0xC1};
    gnss_add_expected_cmd_rsp(cmd_cfg_setval_rate,
                              sizeof(cmd_cfg_setval_rate),
                              resp_cfg_setval_rate,
