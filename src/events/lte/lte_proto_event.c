 ...
 */
static int log_lte_proto_event(const struct event_header *eh, char *buf, size_t buf_len)
{
...
EVENT_TYPE_DEFINE(lte_proto_event, IS_ENABLED(CONFIG_LOG_LTE_PROTO_EVENT), log_lte_proto_event,
		  NULL);
